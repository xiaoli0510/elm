                        ...
                        <section>
                            ...
                            <header class="rating_header">
                                <section class="rating_header_left">
                                    ...
                                    <p>综合评价</p>
                                    <p>高于周边商家{{(ratingScoresData.compare_rating*100)}}%</p>
                                </section>
                                <section class="rating_header_right">
                                    <p>
                                        <span>服务态度</span>
                                        <rating-star :rating='ratingScoresData.service_score'></rating-star>
                                        <span class="rating_num">{{ratingScoresData.service_score}}</span>
                                    </p>
                                    <p>
                                        <span>菜品评价</span>
                                        <rating-star :rating='ratingScoresData.food_score'></rating-star>
                                        <span class="rating_num">{{ratingScoresData.food_score}}</span>
                                    </p>
                                    <p>
                                        <span>送达时间</span>
            ...
            <transition name="fadeBounce">
                <div class="specs_list" v-if="showSpecs">
                    ...
                    <section class="specs_details">
                        ...
                        <ul>
                            <!-- <li v-for="(item, itemIndex) in choosedFoods.specifications[0].values" :class="{specs_activity: itemIndex == specsIndex}" @click="chooseSpecs(itemIndex)" :key="itmIndex"> -->
