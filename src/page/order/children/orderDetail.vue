<template>
    <div class="order_detail_page">
        ...
        <section v-if="!showLoading" id="scroll_section" class="scroll_container" ref="wrapper">
            <section class="scroll_insert">
                ...
                <section class="order_detail_style">
                    ...
                    <section class="item_style">
                        ...
                        <div class="item_right">{{orderDetail.id}}</div>
                    </section>
                    <section class="item_style">
                        <p class="item_left">支付方式：</p>
                        <div class="item_right">在线支付</div>
                    </section>
                    <section class="item_style">
