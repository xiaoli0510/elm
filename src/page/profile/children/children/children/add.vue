	   ...
	   <section class="adddetail">
		   <form action="" v-on:submit.prevent>
			   <section class="ui-padding-block">
				   ...
				   <div class="input-new">
					   <input type="text" placeholder="请填写能够联系到您的手机号" v-model="telenum" @input="inputThingfour"> 
			   ...
			   <section class="addbutton">
				   <button :disabled="!butpart" :class="{butopacity:butpart}" @click.prevent="submitThing">新增地址</button>
			   </section>
		   </form>
	   </section>
	...
	export default {
		data(){
			return{
				 ...
				 standbytele:'',//备用手机号提示
				 verify:false,//姓名提示
				 verifythree:false,//详细地址提示
				 verifyfour:false,//手机号提示
				 verifyfive:false,//备用联系电话提示
				 butpart:false,//新增地址按钮透明度
