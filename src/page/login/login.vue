<template>
    <div class="loginContainer">
        <head-top :head-title="loginWay?'登录':'密码登录'" goBack='true'>
          <div class="change_login" slot="changeLogin" @click="changeLoginWay">{{loginWay?'密码登录':'短信'}}</div>
        </head-top>
        <!-- 短信登录 -->
...
import {mobileCode,getcaptchas, checkExsis,sendLogin,accountLogin} from '../../service/getData';
export default {
  data() {
    return {
